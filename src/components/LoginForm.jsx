  ...
  return (
    <div className="container mx-auto min-h-[80vh] flex justify-center items-center bg-gray-100 px-4">
      <div className="w-full max-w-md p-8 rounded-3xl bg-white shadow-xl my-20">
        <h1 className="text-3xl font-bold text-center mb-6">Login Your Account</h1>
        <form className="space-y-4" onSubmit={handleSubmit(handleLogin)}>
          ...
          <button type="submit" className="w-full bg-lime-500 hover:bg-lime-600 text-white py-3 rounded-xl font-semibold transition">
            Login
          </button>
        </form>
        <p className="text-center text-2xl font-bold mx-2">or</p>
        <button className="btn w-full py-2 rounded-full border border-purple-600 btn-block text-cyan-300 text-center mx-auto flex justify-center items-center bg-lime-950"
        ...
        <p className="mt-5 text-center text-gray-600">
          ...
          <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`}
            className="text-blue-500 font-semibold hover:underline">Register</Link>
        </p>
